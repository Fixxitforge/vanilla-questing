...
- [#3 — Questgiver `!` blips on the minimap](https://github.com/Fixxitforge/vanilla-questing/issues/3).
...
- [#4 — Turn-in markers: `?` versus the gold bullet](https://github.com/Fixxitforge/vanilla-questing/issues/4).
  Close enough to Classic to leave alone by default; offer a purist toggle for gold-bullet-only.
- [#5 — Cross-expansion support](https://github.com/Fixxitforge/vanilla-questing/issues/5). One AddOn
...
- [#6 — A wiki of what this client actually exposes](https://github.com/Fixxitforge/vanilla-questing/issues/6).
...
- [#7 — Remove the live status readout from the canvas fallback rows](https://github.com/Fixxitforge/vanilla-questing/issues/7).
...
- [#8 — The CurseForge description, with a Known limitations section](https://github.com/Fixxitforge/vanilla-questing/issues/8).
...
**Open — [issue #7](https://github.com/Fixxitforge/vanilla-questing/issues/7).** Remove the live status
...
**Open — [issue #8](https://github.com/Fixxitforge/vanilla-questing/issues/8).** Write the CurseForge
...
- **~~`BUGS.md`~~** — open faults, with enough detail to pick one up cold. **Removed in v0.16.1**:
  ...
  [issue #1](https://github.com/Fixxitforge/classic-questing/issues/1).
